...
/**
 * QFlywaySchemaHistory is a Querydsl query type for BFlywaySchemaHistory
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QFlywaySchemaHistory extends com.querydsl.sql.RelationalPathBase<BFlywaySchemaHistory> {

    private static final long serialVersionUID = 1337239239;
    ...
    public final com.querydsl.sql.PrimaryKey<BFlywaySchemaHistory> flywaySchemaHistoryPk = createPrimaryKey(installedRank);

    public QFlywaySchemaHistory(String variable) {
        super(BFlywaySchemaHistory.class, forVariable(variable), "PUBLIC", "flyway_schema_history");
        addMetadata();
    }

    public QFlywaySchemaHistory(String variable, String schema, String table) {
        super(BFlywaySchemaHistory.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QFlywaySchemaHistory(String variable, String schema) {
        super(BFlywaySchemaHistory.class, forVariable(variable), schema, "flyway_schema_history");
        addMetadata();
    }

    public QFlywaySchemaHistory(Path<? extends BFlywaySchemaHistory> path) {
        super(path.getType(), path.getMetadata(), "PUBLIC", "flyway_schema_history");
        addMetadata();
    }

    public QFlywaySchemaHistory(PathMetadata metadata) {
        super(BFlywaySchemaHistory.class, metadata, "PUBLIC", "flyway_schema_history");
        addMetadata();
    }
    ...
    public void addMetadata() {
        ...
        addMetadata(installedOn, ColumnMetadata.named("installed_on").withIndex(8).ofType(Types.TIMESTAMP).withSize(26).withDigits(6).notNull());
